...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p><strong>Executed evidence:</strong> The base policy produced 15.4% more synthetic true incremental net value than the strongest non-oracle baseline, with 5.6% regret; all 19 budget, capacity, and economics stress scenarios passed their constraints.</p>
    ...
    <td width="50%" valign="top">
      ...
      <p><strong>Executed evidence:</strong> The optimized policy produced 76.2% more simulated incremental net value than risk-only targeting; all 9 budget/capacity scenarios passed constraints, with zero overlap-support failures.</p>
...
| Subscription economics | [Subscription Value & P&L](https://github.com/parisaMSTFV/subscription-value-pnl-analytics) | Portfolio P&L, renewal analysis, segmentation, and executable SQL |
