...
<table>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p><strong>Executed evidence:</strong> On the untouched synthetic holdout, the model reduced WAPE by 29.9% versus an RFM baseline and captured 24.4% of realized value in the top 10%.</p>
